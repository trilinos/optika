...
Development is largely user driven. A small user base for Optika has developed at Sandia National Laboratories. Some Sandia scientists have suggested that a stand-alone version 
of Optika used to simply configure parameter lists would be very useful. The ability to undo edits and save a configuration result only contaning the 
parameter list entries that have changed have also been requested.
